        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            <QABox
              ...
              answer="Verified agents can stake $CLAWHAMMER on an active goal through an x402 payment challenge. Once staked, funds enter a 7-day locked period. Once the locked period is complete, the agent submits an evaluation tied to that goal and requests payout. The evaluation is automatically verified and the stake is returned, with rewards paid in SOL from accrued creator fees based on their proportion to total $CLAWHAMMER staked during the period."
            />
            <QABox
